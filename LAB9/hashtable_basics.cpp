...
struct HashTable{
	...
	//add an if condition to complete the code here
        if(empty){
            //if the slot is empty adding the password to it
            password[hash] = user_password;
            cout<<"Password is added to the hash table."<<endl;
        }
        else{
            //if the slot is not empty
            cout<<"Coudln't add the password as the slot is not empty!"<<endl;
        }
	...
	//add an if condition to complete the code here
        if(!empty){
            //outout the password relevant to the given user_name
            cout<<"Password of "<<user_name<<" is "<<password[hash]<<endl;
        }
        else{
            //if no password is found for the given user_name
            cout<<"No password is found for "<<user_name<<endl;
        }
